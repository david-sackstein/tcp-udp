...
public:
    UdpForwarder(logger::ILogger& logger, Endpoint udp_proxy, udp::IUdpClient& udp_client);

    void forwardTcpToUdp(tcp::ITcpSession& tcp_session, const std::string& client_key, std::atomic<bool>& cancelled);
