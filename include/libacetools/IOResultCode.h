...
inline const char* to_string(IOResultCode code) {
    switch (code) {
        case IOResultCode::Success: return "Success";
        case IOResultCode::ConnectionClosed: return "ConnectionClosed";
        case IOResultCode::Timeout: return "Timeout";
        case IOResultCode::Error: return "Error";
    }
}
