...
EXPORTED std::unique_ptr<IBlockingServer> create_tcp_server(logger::ILogger& logger, const Endpoint& local_endpoint, ITcpClientHandler& handler);

EXPORTED std::unique_ptr<IBackgroundServer> start_tcp_server(logger::ILogger& logger, const Endpoint& local_endpoint, ITcpClientHandler& handler);
